...
This project predicts whether a customer is likely to churn based on customer profile, contract, service, tenure, and billing information. It includes exploratory analysis, classification model training (logistic regression, SVM, random forest, XGBoost) through pipelines, and deployment using FastAPI and Streamlit.
